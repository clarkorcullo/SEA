...
def module(module_id):
    ...
    try:
        ...
        if assessment_result and assessment_result.total_questions and assessment_result.total_questions > 0:
            knowledge_check_score = int((assessment_result.score / assessment_result.total_questions) * 100)
        else:
